...
/// @notice Base mainnet deployment script for the People Markets core suite.
/// @dev    Assumes you are deploying with the governance key so post-deploy proposals can be
///         submitted. Timelocked activations are not executed here (Base mainnet time is real).
